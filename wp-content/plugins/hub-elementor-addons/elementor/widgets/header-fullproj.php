		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .lqd-fullproj-trigger .nav-trigger.bordered .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .lqd-fullproj-trigger .nav-trigger.bordered:hover .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .lqd-fullproj-trigger .nav-trigger.bordered.is-active .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.is-stuck {{WRAPPER}} .lqd-fullproj-trigger .nav-trigger.bordered .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.is-stuck {{WRAPPER}} .lqd-fullproj-trigger .nav-trigger.bordered:hover .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.is-stuck {{WRAPPER}} .lqd-fullproj-trigger .nav-trigger.bordered.is-active .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.lqd-active-row-light .lqd-fullproj-trigger .nav-trigger.bordered .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.lqd-active-row-light .lqd-fullproj-trigger .nav-trigger.bordered:hover .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.lqd-active-row-light .lqd-fullproj-trigger .nav-trigger.bordered.is-active .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.lqd-active-row-dark .lqd-fullproj-trigger .nav-trigger.bordered .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.lqd-active-row-dark .lqd-fullproj-trigger .nav-trigger.bordered:hover .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.lqd-active-row-dark .lqd-fullproj-trigger .nav-trigger.bordered.is-active .bars' => 'border-color: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
